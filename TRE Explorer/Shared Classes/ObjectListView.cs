 ...
 * 
 * TO DO:
 * - Incremental update. List has changed slightly (a couple of new items, a couple of items removed)
 *   Do this efficiently. Maintain sort order, scroll position, everything.
...
namespace BrightIdeasSoftware {
  ...
  public partial class ObjectListView : ListView, ISupportInitialize {
    ...
    /// <para><bold>This feature is experiemental!</bold> Strange things may happen to your program, your spouse or your pet if you use it.</para>
    /// </remarks>
    [Category("Appearance"),
     DefaultValue(-1)]
    ...
    #region Column hiding and resizing handling
    ...
    protected bool HandleNotify(ref Message m) {
      ...
      switch (nmhdr.code) {
        ...
        case NM_RCLICK:
          this.PossibleFinishCellEditing();
          isMsgHandled = this.HandleHeaderRightClick();
          break;
    ...
    /// </summary>
    /// <remarks>We cannot rely on <code>lvi.Index</code> in this method.
    ...
    protected OLVColumn lastSortColumn; // which column did we last sort by
    protected SortOrder lastSortOrder; // which direction did we last sort
  ...
  public class VirtualObjectListView : ObjectListView {
    ...
    public OLVListItem MakeListViewItem(int itemIndex) {
      ...
      if (this.UseAlternatingBackColors) {
        ...
        // For some reason, UseItemStyleForSubItems doesn't work for the background color
  ...
  public class FastObjectListView : VirtualObjectListView {
    ...
    /// </summary>
    /// <remarks>This method preserves selection, if possible. Use <code>SetObjects()</code> if
    /// you do not want to preserve the selection. Preserving selection is the slowest part of this
    /// code and performance is O(n) where n is the number of selected rows.</remarks>
    [Browsable(false),
    DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
  ...
  public class FlagRenderer<T> : BaseRenderer where T : IConvertible {
    ...
    public void Add(T key, Object imageSelector) {
      UInt32 k2 = ((IConvertible)key).ToUInt32(NumberFormatInfo.InvariantInfo);
